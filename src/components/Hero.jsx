        ...
        <div className="relative h-screen">
            ...
            <div className="container relative h-full grid grid-cols-1 md:grid-cols-2 gap-8 ">
                <div className="flex flex-col justify-center text-white space-y-2 relative pt-20 md:pt-0">
                    <div className="hidden md:block absolute top-48 -left-10">
                        <svg
                    ...
                    <p className="font-medium text-lg">Halo semuanya, saya...</p>
                    <h1 className="text-2xl md:text-4xl font-semibold">
                        Wayan Deva Adhisthanaya
                    </h1>
                    <p className="text-gray-200 text-sm md:text-lg">
                        Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Atque, tempore consequuntur eligendi tempora
                        aliquid in. Minus libero a quae placeat similique
                        molestias tenetur ratione aliquid qui, corporis sed
                        tempora nisi.
                    </p>
                    <div className="pt-4">
                        <a
                            href="#"
                            className="px-4 py-2 rounded outline outline-2 text-sm md:text-xl"
                        >
                            Unduh CV
                        </a>
                    </div>
                ...
                <div className="flex flex-col justify-center items-center relative">
                    <div className="p-5 bg-white rounded-[50%] w-64 h-64"></div>
                    <div className="absolute left-5 bottom-5 md:left-20 md:bottom-36">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="size-10 md:size-16 text-white -rotate-12"
                        >
                            <path
                                fillRule="evenodd"
                    ...
                    <div className="absolute right-5 top-0 md:right-20 md:top-40">
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="size-10 md:size-16 text-white"
                        >
                            <path
                                fillRule="evenodd"
